...
\begin{description}
	...
	\item[\texttt{BackdropObject}] Ein Objekt, welches ein Bild oder eine Farbe über die Größe
		des gesamten Spielfensters anzeigt. Wird verwendet, um schnell Hintergrundbilder
		einbinden zu können. Das Objekt hat sonst keine weiteren Eigenschaften.
	\item[\texttt{ButtonObject}] Ein Objekt, welches optional ein Bild anzeigt und, wenn es
	    angeklickt wird, beliebigen Code ausführt.
