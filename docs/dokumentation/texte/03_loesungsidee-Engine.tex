...
\begin{itemize}
	...
	\item Einen \textit{Szenenstapel}, also das Anzeigen mehrerer Szenen übereinander, sodass z.B.
	...
	um mehrere Sounds gemeinsam pausieren, fortsetzen oder stoppen zu können.
...
Mit der Klasse \texttt{javax.swing.JFrame} wird das Spielfenster
erstellt. \texttt{Swing} bietet eine große
...
das Zeichnen der Szenen und ihrer Objekte. Diese kann durch
Aufrufen der \texttt{repaint}-Methode dann manuell ausgelöst werden,
um dann so die Grafik mit einer Frequenz von 60Hz zu aktualisieren.
