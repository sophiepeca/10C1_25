...
\begin{itemize}
  ...
  \item Abhängig davon, welche Fachschaft man gewählt hat, bekommt man am Anfang ein (zur Fachschaft passendes) Item, apäter hat die gewählte Fachschaft jedoch keinen Einfluss auf den Spielverlauf.
  \item Es gibt keinen Endgegner, stattdessen hat man das Spiel gewonnen, wenn man alle Lehrer besiegt hat.
\end{itemize}
