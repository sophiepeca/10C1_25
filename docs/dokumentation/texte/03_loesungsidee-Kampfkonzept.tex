Im Kampf geht es darum, dass der Schüler sich gegen den Lehrer beweisen muss. Dafür werden Items unterschiedlicher Level benutzt, die dann von beiden Parteien eingesetzt werden, um sich Lebenspunkte abziehen zu können.\\
...
Der Schaden wird folgendermaßen berechnet: Die Items haben Level von 0 bis 2. Der Schaden, der durch ein Item erzielt wird, ist das Level + 1.\\
...
Wenn dann eine der beiden Parteien $\leq 0$ Lebenspunkte hat, ist der Kampf vorbei.\\
Sollte der Schüler gewonnen haben, ist der Lehrer besiegt. Wenn alle Lehrer besiegt sind, ist das Spiel gewonnen.\\
