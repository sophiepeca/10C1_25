...
Die KampfScene erzeugt ein Hintergrundbild für den Kampf und öffnet das Inventar, sodass der Spieler ein Item auswählen kann. Dabei überlagert die InventarScene den Hintergrund mit SceneStack.INSTANCE.push(new InventarScene()).
