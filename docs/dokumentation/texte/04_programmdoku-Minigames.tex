...
public boolean istGeloest() {
    // Glas muss vollständig gefüllt sein
    if (bloecke.size() != MAX_KAPAZITAET) return false;
    // Alle Blöcke müssen die gleiche Farbe haben
    ...
    for (int i = 0; i < 4; i++) {
        if (imagePlaceholders[i].isClicked()) {
            ...
            if (existing != null) {
                ...
                // Label an seine ursprüngliche Position
