...
\begin{lstlisting}[caption=Switch Cases für die verschiedenen Level, label=lst:mgSwitch(level), captionpos=t, language=Java]
...
Im folgenden Codeausschnitt wird die Bewegung des Balles, basierend auf den Basis- und Spielerkräften ausgeführt, sowie Gewinnbedingungen geprüft.
